    ...
    <Layout>
      <div className="page-container">
        ...
        <div className="shop-gallery">
          <div className="col">
            <Link to="/shop/shop-originals" className="shop-card-link">
          ...
          <div className="col">
            <Link to="/shop/shop-prints" className="shop-card-link">
              <div className="img-container">
                <GatsbyImage
              ...
              {/* <p className="contact-text">
                  ...
                  pieces are available on durable, acid-free, cold-pressed
                  paper. These stunning reproductions come at a significantly
                  reduced price from the originals.
                </p> */}
          ...
          <div className="col">
            <Link to="/shop/shop-cards" className="shop-card-link">
              <div className="img-container">
                <GatsbyImage
              ...
              {/* <p className="contact-text">
                ...
                desired. Simply contact me to indicate which pieces you would
                like in card format and I’ll do the rest!
              </p> */}
  ...
  query {
    shopImages: allCloudinaryMedia(
      ...
      nodes {
        ...
        gatsbyImageData(
          placeholder: BLURRED
          transformations: ["f_auto,q_auto,c_limit,w_600"]
        )
        context {
          custom {
            caption
